  ...
  return (
    <section className="overflow-x-hidden relative mt-14 pt-2 md:mt-26 md:pt-2 flex justify-end">
      ...
      >
        ...
        before:content-['"'] before:h-7 before:absolute before:-top-4 before:font-medium before:text-7xl before:text-[var(--gray)] before:bg-[var(--background)]
        after:content-['"'] after:h-7 after:absolute after:bottom-8 md:after:bottom-12 after:rotate-180 after:right-8 md:after:right-4 after:font-medium after:text-7xl after:text-[var(--gray)] after:bg-[var(--background)]`}
        >
