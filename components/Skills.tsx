...
const cardList = [
  ...
  {
    title: "Other",
    subtitle: "HTML5 CSS3 SASS TailwindCSS Bootstrap BEM",
  },
  {
    title: "Frameworks & Libraries",
    subtitle: "React Next.js Three.js Aiogram",
  },
];

function Skills() {
  return (
    <section className="flex flex-col mt-5 lg:mt-15 lg:flex-row px-4 xl:px-0 xl:max-w-[1024px] mx-auto gap-5 md:gap-10">
      <div className="relative w-full lg:w-2/5 flex items-start">
        <Title>skills</Title>
      ...
      <div className="mt-0 lg:mt-22 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full lg:w-3/5 items-start justify-end">
